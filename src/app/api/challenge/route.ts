...
- 重要：1分間（約300字）で答えきれる分量にすること。「3つ挙げて」「5つ紹介して」のように複数を求めるお題は禁止。1つの事柄を深く説明させるお題にする
- 以下のカテゴリからランダムに選ぶ：
  1. 作り方・手順の説明：「カレーの作り方を説明してください」「引っ越しの手順を教えてください」
  2. 解決策の提案：「朝起きられない問題の解決策を1つ説明してください」「部屋が片付かない悩みへのアドバイスをしてください」
  3. おすすめ紹介：「おすすめの休日の過ごし方を1つ紹介してください」「初心者におすすめの運動を1つ紹介してください」
  4. 比較・意見：「都会と田舎、住むならどちらがいいか説明してください」「紙の本と電子書籍、どちらがおすすめか教えてください」
  5. 仕組みの説明：「なぜ空は青いのか説明してください」「コンビニが便利な理由を説明してください」
